    ...
    {edificios.map((edificio, index) => (
      <div key={index} style = {{
        border: '2mm ridge rgba(33, 35, 38, .8)', maxHeight: 200, maxWidth: 300}}
         ...
         className=' py-6 flex flex-col items-center max-h-100'>
        ...
        <span className=' absolute text-lg text-black bottom-2 mt-2 flex-col max-w-100' >Precio: {edificio.costo} {handleRecursos(edificio.recurso)}</span>
      </div>
